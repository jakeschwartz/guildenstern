...
export const seedThreads: Thread[] = [
  {
    ...
    messages: [
      ...
      },
      {
        id: "ja-prev-briefing",
        author: { kind: "agent" },
        body: "Yesterday's morning briefing — all 3 items addressed.",
        createdAt: hr(20),
        foldGroupId: "ja-yesterday-briefing",
        foldSummary: "Yesterday's briefing · 3 items, all resolved",
      },
      {
        id: "ja-2",
        author: { kind: "human", userId: "jake" },
        body: "remind me to call my dad friday morning",
        createdAt: hr(0.4),
        foldGroupId: "ja-dad-reminder",
        foldSummary: "Reminder set · Call dad Friday morning",
      },
      {
        id: "ja-3",
        author: { kind: "agent" },
